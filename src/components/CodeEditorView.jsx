...
export function CodeEditorView({
  ...
  // Android Studio Layout View Mode: "code" | "split" | "design"
  ...
  const isXmlOrAvatarFile = activeFile.id === "profile-image" || activeFile.type === "xml";
  ...
  return (
    <div className="flex-1 bg-[var(--bg-primary)] flex flex-col overflow-hidden font-mono text-xs relative selection:bg-[#3574F0]/40 selection:text-white select-none">
      {/* ---------------- ANDROID STUDIO CODE / SPLIT / DESIGN MODE SWITCHER ---------------- */}
      <div className="h-8 border-b border-[var(--border-color)] bg-[var(--bg-secondary)] px-3 flex items-center justify-between text-[11px] shrink-0">
        <div className="flex items-center space-x-2 text-[var(--text-muted)]">
          ...
          <span className="text-[10px] px-2 py-0.2 rounded bg-[var(--bg-tertiary)] border border-[var(--border-color)] text-[#3DDC84]">
            {isXmlOrAvatarFile ? "XML Layout & Asset" : "Kotlin Source"}
          </span>
        </div>
        ...
        <div className="flex items-center space-x-1 bg-[var(--bg-primary)] p-0.5 rounded-lg border border-[var(--border-color)]">
          <button
            ...
            className={`px-2.5 py-0.5 rounded flex items-center space-x-1 transition-all cursor-pointer ${
              editorMode === "code" ? "bg-[#3574F0] text-white font-bold" : "text-[var(--text-muted)] hover:text-white"
            }`}
          ...
          <button
            ...
            className={`px-2.5 py-0.5 rounded flex items-center space-x-1 transition-all cursor-pointer ${
              editorMode === "split" ? "bg-[#3574F0] text-white font-bold" : "text-[var(--text-muted)] hover:text-white"
            }`}
            title="Split Code & Android Preview View"
          >
            <Columns size={12} />
            <span>Split</span>
          </button>
          ...
          <button
            ...
            className={`px-2.5 py-0.5 rounded flex items-center space-x-1 transition-all cursor-pointer ${
              editorMode === "design" ? "bg-[#3574F0] text-white font-bold" : "text-[var(--text-muted)] hover:text-white"
            }`}
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        {/* Right Side: Android Studio Layout Preview Window (When in Split or Design Mode) */}
        {(editorMode === "design" || editorMode === "split" || isXmlOrAvatarFile) && (
